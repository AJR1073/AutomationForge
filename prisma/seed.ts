...
const PRODUCTS = [
  { name: 'Shelly 1 Gen3', brand: 'Shelly', tags: ['relay', 'switch'], price: '$12', affiliate: 'https://www.amazon.com/s?k=Shelly+1+Gen3' },
  { name: 'Shelly Plug S Gen3', brand: 'Shelly', tags: ['smart_plug', 'energy_monitor'], price: '$18', affiliate: 'https://www.amazon.com/s?k=Shelly+Plug+S' },
  { name: 'Shelly 1PM Plus', brand: 'Shelly', tags: ['relay', 'energy_monitor'], price: '$16', affiliate: 'https://www.amazon.com/s?k=Shelly+1PM+Plus' },
  { name: 'Shelly Dimmer 2', brand: 'Shelly', tags: ['dimmer', 'light'], price: '$22', affiliate: 'https://www.amazon.com/s?k=Shelly+Dimmer+2' },
  { name: 'Aqara Motion Sensor P1', brand: 'Aqara', tags: ['motion_sensor', 'zigbee'], price: '$18', affiliate: 'https://www.amazon.com/s?k=Aqara+Motion+Sensor+P1' },
  { name: 'Sonoff ZBDONGLE-P Zigbee Coordinator', brand: 'Sonoff', tags: ['zigbee_coordinator'], price: '$20', affiliate: 'https://www.amazon.com/s?k=Sonoff+ZBDONGLE-P' },
  { name: 'ESP32 Development Board', brand: 'Espressif', tags: ['controller', 'esphome'], price: '$8', affiliate: 'https://www.amazon.com/s?k=ESP32+development+board' },
  { name: 'DHT22 Temperature Sensor', brand: 'Generic', tags: ['temperature_sensor', 'humidity_sensor'], price: '$5', affiliate: 'https://www.amazon.com/s?k=DHT22+temperature+sensor' },
  { name: 'DS18B20 Waterproof Temp Sensor', brand: 'Generic', tags: ['temperature_sensor', 'waterproof'], price: '$6', affiliate: 'https://www.amazon.com/s?k=DS18B20+waterproof' },
  { name: 'Magnetic Door/Window Sensor', brand: 'Aqara', tags: ['door_sensor', 'zigbee'], price: '$15', affiliate: 'https://www.amazon.com/s?k=Aqara+door+sensor' },
  { name: 'GOVEE Water Leak Sensor', brand: 'Govee', tags: ['leak_sensor', 'wifi'], price: '$20', affiliate: 'https://www.amazon.com/s?k=Govee+water+leak+sensor' },
  { name: 'Raspberry Pi 4 (2GB)', brand: 'Raspberry Pi', tags: ['controller', 'ha_server'], price: '$50', affiliate: 'https://www.amazon.com/s?k=Raspberry+Pi+4+2GB' },
  { name: 'WLED LED Strip Controller', brand: 'WLED', tags: ['light', 'led_strip', 'esphome'], price: '$15', affiliate: 'https://www.amazon.com/s?k=WLED+LED+controller' },
  { name: 'PIR Motion Sensor HC-SR501', brand: 'Generic', tags: ['motion_sensor', 'pir'], price: '$3', affiliate: 'https://www.amazon.com/s?k=HC-SR501+PIR+motion+sensor' },
  { name: 'Zigbee Smart Plug (Ikea Tradfri)', brand: 'IKEA', tags: ['smart_plug', 'zigbee', 'energy_monitor'], price: '$12', affiliate: 'https://www.amazon.com/s?k=IKEA+Tradfri+smart+plug' },
];
