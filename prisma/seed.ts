...
const PRODUCTS = [
  { name: 'Shelly 1 Gen3', brand: 'Shelly', tags: ['relay', 'switch'], price: '$12', image: '/products/shelly-relay.png', asin: 'B0D8YPW46Y', affiliate: 'https://www.amazon.com/dp/B0D8YPW46Y?tag=automforge20-20' },
  { name: 'Shelly Plug S Gen3', brand: 'Shelly', tags: ['smart_plug', 'energy_monitor'], price: '$18', image: '/products/smart-plug.png', asin: 'B0D2K21VJD', affiliate: 'https://www.amazon.com/dp/B0D2K21VJD?tag=automforge20-20' },
  ...
  { name: 'Shelly Dimmer 2', brand: 'Shelly', tags: ['dimmer', 'light'], price: '$22', image: '/products/dimmer.png', asin: 'B08182Y88D', affiliate: 'https://www.amazon.com/dp/B08182Y88D?tag=automforge20-20' },
  { name: 'Aqara Motion Sensor P1', brand: 'Aqara', tags: ['motion_sensor', 'zigbee'], price: '$18', image: '/products/motion-sensor.png', asin: 'B0B9XZ1D51', affiliate: 'https://www.amazon.com/dp/B0B9XZ1D51?tag=automforge20-20' },
  ...
  { name: 'ESP32 Development Board', brand: 'Espressif', tags: ['controller', 'esphome'], price: '$8', image: '/products/esp32.png', asin: 'B0B19KRJN6', affiliate: 'https://www.amazon.com/dp/B0B19KRJN6?tag=automforge20-20' },
  { name: 'DHT22 Temperature Sensor', brand: 'Generic', tags: ['temperature_sensor', 'humidity_sensor'], price: '$5', image: '/products/temp-sensor.png', asin: 'B0795F19W6', affiliate: 'https://www.amazon.com/dp/B0795F19W6?tag=automforge20-20' },
  { name: 'DS18B20 Waterproof Temp Sensor', brand: 'Generic', tags: ['temperature_sensor', 'waterproof'], price: '$6', image: '/products/temp-sensor.png', asin: 'B012C597T0', affiliate: 'https://www.amazon.com/dp/B012C597T0?tag=automforge20-20' },
  { name: 'Magnetic Door/Window Sensor', brand: 'Aqara', tags: ['door_sensor', 'zigbee'], price: '$15', image: '/products/door-sensor.png', asin: 'B07D37VDM3', affiliate: 'https://www.amazon.com/dp/B07D37VDM3?tag=automforge20-20' },
  { name: 'GOVEE Water Leak Sensor', brand: 'Govee', tags: ['leak_sensor', 'wifi'], price: '$20', image: '/products/leak-sensor.png', asin: 'B07PLLSJPG', affiliate: 'https://www.amazon.com/dp/B07PLLSJPG?tag=automforge20-20' },
  { name: 'Raspberry Pi 4 (2GB)', brand: 'Raspberry Pi', tags: ['controller', 'ha_server'], price: '$50', image: '/products/raspberry-pi.png', asin: 'B07TD42S27', affiliate: 'https://www.amazon.com/dp/B07TD42S27?tag=automforge20-20' },
  { name: 'WLED LED Strip Controller', brand: 'WLED', tags: ['light', 'led_strip', 'esphome'], price: '$15', image: '/products/esp32.png', asin: 'B0B6GP2G8C', affiliate: 'https://www.amazon.com/dp/B0B6GP2G8C?tag=automforge20-20' },
