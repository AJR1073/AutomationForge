...
const PRODUCTS = [
  ...
  { name: 'GOVEE Water Leak Sensor', brand: 'Govee', tags: ['leak_sensor', 'wifi'], price: '$20', image: '/products/leak-sensor.png', asin: 'B07J9HZ5VN', affiliate: 'https://www.amazon.com/dp/B07J9HZ5VN?tag=automforge20-20' },
  { name: 'Raspberry Pi 4 Kit', brand: 'Raspberry Pi', tags: ['controller', 'ha_server'], price: '$90', image: '/products/raspberry-pi.png', asin: 'B089ZZ6DN5', affiliate: 'https://www.amazon.com/dp/B089ZZ6DN5?tag=automforge20-20' },
